...
const Partnerprogram = () => {
  return (
    <>
      <PageHero 
        subtitle=""
        title="Partner with Finb: Innovate and Grow Together"
        paragraph="Join Finb Tech's Partner Program to expand your offerings with cutting-edge
    ...
    <section className="relative pb-20 pt-150 max-md:overflow-hidden max-md:pb-25 max-md:pt-25" style={{ backgroundColor: '#462AD4' }}>
      <div className="container relative ">
        ...
        <div className=" mx-auto text-center">
          ...
          Ready to partner with Finb? Contact us today to learn more and get started.</p>
