      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-">
         <div className="max-w-[1000px]">
            ...
            <b>Introduction:-</b>"Founded over a decade ago, Finb Tech has emerged as a visionary leader in the financial technology landscape, dedicated to developing solutions that not only meet today’s financial challenges but also anticipate tomorrow’s opportunities."
            <br/>
            <br/>
          ...
          <br/>
              <p className='text-white'>
              "With more than ten years of industry experience, Finb Tech has mastered the art of blending cutting-edge technology with deep financial insights to deliver unparalleled solutions. Our expertise spans across critical financial processes, including KYC verifications, payment solutions, and risk management, all designed to enhance operational efficiency and security"
            </p>
          </div>
        </div>
      </div>
