          ...
          <div className="max-md:order-1 lg:-mt-15">
            ...
            <li className="flex items-center gap-x-2">
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium dark:text-white"><b>Efficiency and Growth-</b> Achieve faster market penetration and improved ROI with Finb Tech’s scalable solutions</span>
              </li>
