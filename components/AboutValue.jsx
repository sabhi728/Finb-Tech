      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-center gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
           ...
           <b> Unique Approach:-</b> "At Finb Tech, we combine technological prowess with financial acumen to create solutions that are not only technically robust but also commercially viable and user-friendly."
            <br/>
            <br/>
