      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-">
          <div className="max-w-[1000px]">
            ...
            <br/>
            <p className="text-white">
              Promote Finb’s offerings to your network and earn competitive commissions on every transaction.
            </p>
            <br/>
            <br/>
            ...
            <br/>
            <p className="text-white">
              Integrate Finb’s solutions into your platforms, offering your clients enhanced financial services with our robust APIs.
            </p>
            <br/>
            <br/>
