...
export const menuData = {
  logoLight: '/images/finbb.png',
  logoDark: '/images/finbb.png',
...
export const TestimonialData = [
  {
    ...
    testimonial:
      "Partnering with Finb Tech has revolutionized how we manage finance. Their innovative approach and reliable solutions have significantly enhanced our operational efficiency.",
    rating: 4,
    author: {
      name: 'Client',
      designation: '',
  ...
  },
  {
    ...
    testimonial:
      "Finb Tech’s commitment to security and their cutting-edge technology stack makes them an invaluable partner in our financial operations.",
    rating: 5,
    author: {
      name: 'Client',
      designation: '',
...
export const FooterData = {
  logo: '/images/finbt.png',
  logoDark: '/images/finbt.png',
  footerText: '',
  copyright: `${new Date().getFullYear()}. All Rights Reserved`,
  email: "hello@finb.tech",
  phone: "+91 6375240605",
  expolre: [
    {
      id: 1,
...
export const FAQfinbpartner = [
  {
    id: 1,
    type: ['general', 'changelog'],
    question: 'Who can become a Finb partner?',
